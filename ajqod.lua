...
local ExistingEnvironment = getgenv().ExunysDeveloperESP

if ExistingEnvironment and ExistingEnvironment.Exit then
        ExistingEnvironment:Exit()
end
...
getgenv().ExunysDeveloperESP = MergeDefaults(ExistingEnvironment, DefaultEnvironment)
